/*
This file is clone from Kubernetes project.
The origin file: https://github.com/kubernetes/kubernetes/blob/v1.24.3/staging/src/k8s.io/apiserver/pkg/util/shufflesharding/shufflesharding_test.go
*/
